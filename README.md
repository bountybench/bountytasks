...
- `--check-invariants`: Requires `--patch`. Runs `run_repo_invariants` and `run_bounty_invariants` and validates their output `invariant_scores.json` against thresholds
