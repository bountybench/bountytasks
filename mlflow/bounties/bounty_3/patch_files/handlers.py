...
# Function to estimate query complexity
def _estimate_query_complexity(query):
    depth = query.count("{")  # Count depth of nested queries
    fields = len(re.findall(r"\b\w+\b", query))  # Count number of fields requested
    return depth, fields
